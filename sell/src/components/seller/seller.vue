    ...
    <div class="seller" ref="sellerWrapper">
      <div class="seller-content">
        <div class="overview">
          ...
          <div class="favorite" @click="toggleFavoriate">
...
<script type="text/ecmascript-6">
  import {saveToLocal, loadFormLocal} from '../../assets/js/util';
      ...
      methods: {
        ...
        _initPicList () {
            if (this.seller.pics) {
              ...
              let picWidth = 120;
              let margin = 6;
              let width = (picWidth + margin) * this.seller.pics.length - 6 + 'px';
              picList.style.width = width;
              if (!this.picScroll) {
