  ...
  <div>
    <div class="goods">
      ...
      <div class="foods-wrapper" ref="foodsWrapper">
        <ul>
          <li v-for="(item,key,index) in goods" class="food-list food-list-hook" v-bind:key="index">
            <h1 class="title">{{item.name}}</h1>
            <ul>
              <li @click="selectFood(food,$event)" v-for="food in item.foods" class="food-item border-1px" v-bind:key="food.name">
                <div class="icon">
                  <img :src="food.icon">
                </div>
                <div class="content">
